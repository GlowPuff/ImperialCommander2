## Traduzir Imperial Commander 2 → PT-BR: Fase 4 - Expansão Jabba

### 📋 Contexto
Traduzir as **16 missões** da expansão **Jabba's Realm** do Imperial Commander 2 para português brasileiro.
...
```bash
mkdir -p ImperialCommander2/Assets/Resources/Languages/Br/Missions/Jabba
```

**Passo 2:** Para cada missão em `SagaMissions/Jabba/`:
- Copiar para `Languages/Br/Missions/Jabba/` com sufixo `_BR`
...
### 📝 Commit
```
feat(i18n): traduzir missoes Jabba para PT-BR (Fase 4)
```

### 🏷️ Labels
`translation`, `pt-br`, `fase-4`, `missions`, `jabba`
